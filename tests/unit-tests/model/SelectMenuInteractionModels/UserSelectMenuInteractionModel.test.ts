...
const mockInteraction = {
  ...
  isUserSelectMenu: jest.fn().mockReturnValue(true)
};
...
describe('UserSelectMenuInteractionModel', () => {
  ...
  beforeEach(() => {
    ...
    mockInteraction.isUserSelectMenu = jest.fn().mockReturnValue(true);
  });
  ...
  describe('canHandle', () => {
    ...
    it('should return false if interaction is not a correct interaction', () => {
      mockInteraction.isUserSelectMenu = jest.fn().mockReturnValue(false);
