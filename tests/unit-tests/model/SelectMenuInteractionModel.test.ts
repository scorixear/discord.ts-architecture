...
describe('SelectMenuInteractionModel', () => {
  let SuT: TestSelectMenuInteractionModel;
  beforeEach(() => {
    jest.clearAllMocks();
    jest.useFakeTimers();
    SuT = new TestSelectMenuInteractionModel('test', 1000, true);
  ...
  describe('handle', () => {
    it('should not call if deferReply is undefined', async () => {
      SuT = new TestSelectMenuInteractionModel('test', undefined, true);
      SuT.callSuperHandle = true;
