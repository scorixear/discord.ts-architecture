...
describe('ButtonInteractionModel', () => {
  let SuT: TestButtonInteractionModel;
  beforeEach(() => {
    jest.clearAllMocks();
    jest.useFakeTimers();
    SuT = new TestButtonInteractionModel('test', 1000, true);
  ...
  describe('constructor', () => {
    it('should set the id, deferReply, deferReplyEphemeral and component', () => {
      ...
      expect((SuT.component.data as any).custom_id).toBe('test');
    });
  });

  describe('activateDeferredReply', () => {
    it('should not call if deferReply is undefined', async () => {
      SuT = new TestButtonInteractionModel('test', undefined, true);
  ...
  describe('canHandle', () => {
    it('should return true if command is the same and interaction is a ButtonInteraction', () => {
    ...
    it('should return false if interaction is not a ButtonInteraction', () => {
